...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/","/sidebar","/accidentL","/main","/images/**","/loginSlct","/register","/ipReg","/iaReg","/emReg","/garage","/garageForm","/manager","/garageHome","/admin","/adminForm","/adminRegform","/home","/managerForm","/report/**","/getGarage/**","/getEmergencyVehicle/**","/claimAccept/**","/checkClaim/**","/adjusterUpLoc/**","/getDirection/**","/SentToGarage/**","/reportPost","/files/**","/updateAccident/**","/logIn/**","/getLocation/**","/emvAvail/**","/getPay/**","/acceptance/**","/getEmergencyVehicle/**").permitAll()
